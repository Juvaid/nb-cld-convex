...
export default function ProductCard({ category }: { category: ProductCategory }) {
    return (
        <div className="group relative rounded-[32px] sm:rounded-[40px] overflow-hidden bg-white border border-slate-900/5 hover:shadow-2xl hover:shadow-[#16a34a]/10 transition-all duration-500 hover:-translate-y-2 sm:hover:-translate-y-3">
            {/* Main Clickable Area */}
            <Link href={`/products/${category.slug}`} className="block">
                ...
                <div className="h-48 sm:h-64 bg-slate-50 flex items-center justify-center relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#16a34a]/10 to-[#2bee6c]/10 opacity-50" />
                    ...
                    <div className="absolute top-4 sm:top-6 right-4 sm:right-6 z-20">
                        <div className="bg-white/40 backdrop-blur-md px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-widest text-[#16a34a] flex items-center gap-1 sm:gap-1.5 border border-white/40">
                ...
                <div className="p-8 sm:p-10">
                    <h3 className="font-black text-xl sm:text-2xl text-slate-900 mb-2 sm:mb-3 group-hover:text-[#16a34a] transition-colors leading-tight">
                        {category.name}
                    </h3>
                    ...
                    <div
                        className="inline-flex items-center gap-2 text-xs sm:text-sm font-black text-slate-900 group-hover:text-[#16a34a] transition-colors py-2.5 sm:py-3 px-5 sm:px-6 rounded-xl sm:rounded-2xl bg-slate-900/5 group-hover:bg-[#16a34a]/5"
                    >
                        Learn More
            ...
            <div className="px-8 pb-8 sm:px-10 sm:pb-10">
                <Link
                    href="/contact"
                    className="inline-flex items-center gap-1 text-[10px] font-black text-white bg-nb-green px-4 py-2 rounded-full hover:shadow-lg hover:shadow-[#2bee6c]/20 transition-all w-full justify-center uppercase tracking-widest"
                >
                    Inquire for Bulk
                </Link>
            </div>
