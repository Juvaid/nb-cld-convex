...
import { Search, Image as ImageIcon, X, Loader2, UploadCloud, Check, ArrowUpDown, Video, FileText, Play, Edit3, Trash2 } from "lucide-react";
                    ...
                    <div className="w-full h-full flex items-center justify-center p-2">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                            <button
                                ...
                                className="bg-white text-slate-900 w-8 h-8 flex items-center justify-center rounded-lg shadow-lg hover:scale-105 transition-transform"
                                title="Change Image"
                            >
                                <ArrowUpDown size={14} />
                            </button>
                            <button
                                ...
                                className="bg-slate-900 text-white w-8 h-8 flex items-center justify-center rounded-lg shadow-lg hover:scale-105 transition-transform"
                                title="Edit Image"
                            >
                                <Edit3 size={14} />
                            </button>
                            <button
                                ...
                                className="bg-nb-green text-slate-900 w-8 h-8 flex items-center justify-center rounded-lg shadow-lg hover:scale-105 transition-transform"
                                title="SEO/Alt Text"
                            >
                                <Search size={14} />
                            </button>
                            <button
                                ...
                                className="bg-red-500 text-white w-8 h-8 flex items-center justify-center rounded-lg shadow-lg hover:scale-105 transition-transform"
                                title="Remove Image"
                            >
                                <Trash2 size={14} />
                            </button>
