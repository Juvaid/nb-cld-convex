...
export const Footer = ({
    ...
    const finalLogoText = siteSettings?.logoText || logoText;
    const finalDescription = siteSettings?.footerDescription || description;
    const finalCopyrightText = siteSettings?.footerCopyrightText || copyrightText;
    const finalSocialLinks = (siteSettings?.socialLinks as any[]) || socialLinks;
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-16 mb-16 sm:mb-20">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <Link href="/" className="flex items-center gap-3 group">
                            ...
                            <div>
                                <span className={`text-xl sm:text-2xl font-black tracking-tight leading-none block ${textColor}`}>{finalLogoText}</span>
